class PasswordInput {
    ...
    static create(id, placeholder = "Password") {
        ...
        container.className = "password-field";
        ...
        const toggle = container.querySelector(".toggle-eye");
        ...
        toggle.addEventListener("click", () => {
            ...
            if(input.type === "password") {
                ...
                input.type = "text";
                toggle.innerHTML = iconEyeHide;

            } else {

                input.type = "password";
                toggle.innerHTML = iconEyeShow;
